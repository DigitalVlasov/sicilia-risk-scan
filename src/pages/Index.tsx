...
const QUESTIONS = [
  ...
  { id: "settore", title: "In quale settore opera principalmente la tua azienda?", subtitle: "Scegli l'opzione più vicina alla tua realtà", type: "multiplier", options: [{ value: "edilizia", label: "Edilizia/Costruzioni", multiplier: 2 },{ value: "manifatturiero", label: "Manifatturiero/Produzione", multiplier: 1.6 },{ value: "alimentare", label: "Alimentare/Ristorazione", multiplier: 1.5 },{ value: "servizi", label: "Servizi/Consulenza", multiplier: 1.2 },{ value: "commercio", label: "Commercio/Retail", multiplier: 1.2 },{ value: "agricoltura", label: "Agricoltura/Allevamento", multiplier: 1.6 }] },
