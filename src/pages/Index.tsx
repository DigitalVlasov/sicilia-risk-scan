...
const QUESTIONS = [
  { id: "gestione", title: "Come gestisci attualmente la sicurezza aziendale?", subtitle: "Non determina il rischio, ci serve per personalizzare meglio il report", type: "multiplier", options: [{ value: "gestisco-io", label: "Gestisco io personalmente", multiplier: 1.5 },{ value: "interno", label: "Persona dedicata internamente", multiplier: 1.3 },{ value: "consulente", label: "Consulente specializzato", multiplier: 1 },{ value: "studi-multipli", label: "Diversi professionisti", multiplier: 1.2 }] },
  { id: "dipendenti", title: "Quanti dipendenti ha la tua azienda?", subtitle: "Non determina il rischio, ci serve per personalizzare meglio il report", type: "multiplier", options: [{ value: "1-5", label: "1-5 dipendenti", multiplier: 1 },{ value: "6-10", label: "6-10 dipendenti", multiplier: 1.3 },{ value: "11-20", label: "11-20 dipendenti", multiplier: 1.8 },{ value: ">20", label: "Oltre 20 dipendenti", multiplier: 2.2 }] },
  { id: "settore", title: "In quale settore opera principalmente la tua azienda?", subtitle: "Non determina il rischio, ci serve per personalizzare meglio il report", type: "multiplier", options: [{ value: "edilizia", label: "Edilizia/Costruzioni", multiplier: 2 },{ value: "manifatturiero", label: "Manifatturiero/Produzione", multiplier: 1.6 },{ value: "alimentare", label: "Alimentare/Ristorazione", multiplier: 1.5 },{ value: "servizi", label: "Servizi/Consulenza", multiplier: 1.2 },{ value: "commercio", label: "Commercio/Retail", multiplier: 1.2 },{ value: "agricoltura", label: "Agricoltura/Allevamento", multiplier: 1.6 }] },
